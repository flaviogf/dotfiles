...
keymap('n', '<leader><C-b>o', '<cmd>lua require("dap").repl.toggle({}, "vsplit")<cr>', opts)
keymap('n', '<leader><C-b>b', '<cmd>lua require("dap").toggle_breakpoint()<cr>', opts)
keymap('n', '<leader><C-b>tc', '<cmd>lua require("jdtls").test_class()<cr>', opts)
keymap('n', '<leader><C-b>tn', '<cmd>lua require("jdtls").test_nearest_method()<cr>', opts)
