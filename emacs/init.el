...
(custom-set-variables
 ...
 '(package-selected-packages
   '(go-mode all-the-icons-dired which-key vterm use-package seeing-is-believing rspec-mode rainbow-mode projectile perspective magit lsp-mode haskell-mode exwm evil-collection edwina doom-themes doom-modeline desktop-environment counsel company all-the-icons)))
(custom-set-faces
